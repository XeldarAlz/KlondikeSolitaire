...
```csharp
// BAD — bundles all dependencies into one object, everyone sees everything
...
// Consumers: [Inject] void Construct(GameContext ctx) → hides real dependencies

// GOOD — each class declares only what it needs
public sealed class ScoreView : MonoBehaviour
{
    [Inject]
    public void Construct(ScoreModel model) { ... }  // Only ScoreModel, nothing else
}
```
