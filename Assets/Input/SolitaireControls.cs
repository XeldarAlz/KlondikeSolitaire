...
//     version 1.19.0
//     from Assets/Input/SolitaireControls.inputactions
//
...
namespace KlondikeSolitaire.Input
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/SolitaireControls.inputactions".
    /// </summary>
    /// <remarks>
    ...
    /// </code>
    /// </example>
    public partial class @SolitaireControls: IInputActionCollection2, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public @SolitaireControls()
        {
            asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""SolitaireControls"",
    ""maps"": [
        {
            ""name"": ""Game"",
    ...
    ""controlSchemes"": []
        ...
        ~@SolitaireControls()
        {
            UnityEngine.Debug.Assert(!m_Game.enabled, "This will cause a leak and performance issues, SolitaireControls.Game.Disable() has not been called.");
        }
        ...
        {
            private @SolitaireControls m_Wrapper;

            /// <summary>
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public GameActions(@SolitaireControls wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            ...
            /// <summary>
            /// Provides access to the underlying input action "Game/Delta".
            /// </summary>
