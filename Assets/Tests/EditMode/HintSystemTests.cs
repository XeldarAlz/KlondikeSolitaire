...
namespace KlondikeSolitaire.Tests
{
    ...
    public sealed class HintSystemTests
    {
        ...
        private TestSubscriber<HintRequestedMessage> _hintRequestedSubscriber;
        ...
        public void SetUp()
        {
            ...
            _hintRequestedSubscriber = new TestSubscriber<HintRequestedMessage>();
        ...
        public void GetNextHint_NoMovesBoard_DoesNotPublishHintHighlightMessage()
        {
            ...
            var sut = new HintSystem(board, _moveEnumerator, _boardStateSubscriber, _hintRequestedSubscriber, _hintHighlightPublisher, _hintClearedPublisher);
        ...
        public void OnBoardStateChanged_ClearsCache_SubsequentGetNextHintRecalculatesMoves()
        {
            ...
            var hintRequestedSub = new TestSubscriber<HintRequestedMessage>();
            var sut = new HintSystem(board, _moveEnumerator, subscriber, hintRequestedSub, hintPublisher, clearedPublisher);
        ...
        public void Dispose_AfterDispose_BoardStateChangedNoLongerPublishesHintCleared()
        {
            var subscriber = new TestSubscriber<BoardStateChangedMessage>();
            var clearedPublisher = new TestPublisher<HintClearedMessage>();
            var hintReqSub = new TestSubscriber<HintRequestedMessage>();
            var sut = new HintSystem(_board, _moveEnumerator, subscriber, hintReqSub, _hintHighlightPublisher, clearedPublisher);
        ...
        {
            var sut = new HintSystem(_board, _moveEnumerator, _boardStateSubscriber, _hintRequestedSubscriber, _hintHighlightPublisher, _hintClearedPublisher);
            sut.Dispose();
